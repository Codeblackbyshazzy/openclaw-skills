...
| [Clanker](https://clanker.world) | [clanker](clanker/) | Deploy ERC20 tokens on Base, Ethereum, Arbitrum, and other EVM chains. Supports V4 deployment with Uniswap liquidity pools, vesting, airdrops, dev buys, custom market caps, vanity addresses, and multi-chain deployment. |
